    ...
    with_window([](auto window) {
      ...
      glBindVertexArray(VAO);
        ...
        const GLfloat vertices[] = {
          // Position        // Color delta     // Texture coords
          -0.5f, -0.5f, 0.f,  0.2f, -0.1f, 1.f, 0.f, 0.f,
           0.5f, -0.5f, 0.f, -0.1f,  0.2f, 2.f, 1.f, 0.f,
          -0.5f,  0.5f, 0.f,  0.1f,  0.2f, 2.f, 0.f, 1.f,
           0.5f,  0.5f, 0.f, -0.2f, -0.1f, 1.f, 1.f, 1.f
        };
